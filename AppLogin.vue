<template>
  <main class="login-page" :class="{ 'dark-mode': isDarkMode, 'light-mode': !isDarkMode }">
    ...
    <div class="top-controls">
      ...
      <button @click="toggleTheme" class="theme-button" :title="isDarkMode ? 'Modo Claro' : 'Modo Escuro'">
      ...
      <div class="flip-container" :class="{ 'flipped': isRegisterMode }">
        ...
        <div class="flip-card login-side">
          ...
          <div class="logo-container">
            <img 
              :src="isDarkMode ? '/src/assets/images/ARALDI-TECH-VETOR-PEQ-BRANCA.png' : '/src/assets/images/ARALDI-TECH-VETOR-PEQ-PRETA.png'" 
              alt="AraldiTech Logo" 
              class="logo"
            />
          </div>
          ...
          <div class="login-header">
            <h1>Sistema de Fábrica</h1>
            <h2>Gerenciamento de Produção de Ração</h2>
          </div>
...
import { runAllTests } from '@/utils/testIntegration'
import api from '@/api/api' // importa o serviço de API já existente
  ...
  setup() {
    ...
    const showLoginSuccess = async () => {
      ...
      setTimeout(() => {
        ...
        const targetRoute = window.pendingNavigation || '/home'
...
<style scoped>
@import '../assets/styles/login-feedback.css';
