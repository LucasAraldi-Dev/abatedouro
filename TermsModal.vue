    ...
    <div class="modal-content terms-modal">
      ...
      <div class="modal-body" @scroll="checkScrollPosition" ref="termsContent">
        <div class="terms-content">
          ...
          <p>Ao acessar e usar o Sistema de Fábrica AraldiTech, você concorda em cumprir e estar vinculado a estes Termos de Serviço.</p>
          
          <h4>2. Uso do Sistema</h4>
          <p>O sistema é destinado exclusivamente para o gerenciamento de produção de ração e operações relacionadas. O usuário compromete-se a:</p>
          <ul>
